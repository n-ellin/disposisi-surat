...
class PanduanUserPage extends StatefulWidget {
  final String nama;
  final String email;

  final Role role;

  const PanduanUserPage({
    super.key,
    required this.nama,
    required this.email,
  ...
  @override
  State<PanduanUserPage> createState() => _PanduanUserPageState();
}

class _PanduanUserPageState extends State<PanduanUserPage> {
  ...
  final List<Map<String, dynamic>> _steps = [
    ...
    {
      'title': 'Detail Surat',
      'tujuan': 'Melihat dan mengonfirmasi surat yang diterima.',
      'items': [
        {
        ...
        },
        {
          ...
          'text': 'Baca catatan dari Wakil Kepala Sekolah.',
        },
        {
          'icon': Icons.check_circle_outline,
          'text':
              'Tekan tombol Konfirmasi untuk memberitahu bahwa surat telah diterima dan dibaca.',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      'items': [
        ...
        },
        {
          ...
          'text': 'Ubah kata sandi melalui menu Keamanan.',
        },
        {
          'icon': Icons.logout,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: rf(8)),
                Text(
                  'Panduan ini membantu guru memahami surat disposisi yang diterima melalui aplikasi administrasi sekolah.',
                  style: TextStyle(
