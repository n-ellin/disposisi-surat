class ApiConfig {
  ...
  static String suratMasukVerifikasi(int id) =>
      '/api/surat-masuk/$id/verifikasi';
  ...
  static String suratKeluarVerifikasi(int id) =>
      '/api/surat-keluar/$id/verifikasi';
  static String suratKeluarVerifikasiUnified(int id) =>
      '/api/surat-keluar/$id/verifikasi-unified';
  static String suratKeluarDistribusi(int id) =>
      '/api/surat-keluar/$id/distribusi';
  ...
  // PDF
  static String pdfUrl(String filename) => '$baseUrl/uploads/$filename';
}
